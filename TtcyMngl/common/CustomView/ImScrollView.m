...
+(id)ImScrollViewWithFrame:(CGRect)frame jsonUrl:(NSString *)jsonUrl{
    ...
    NSArray *array = [[NSArray alloc] initWithObjects:@"intro_content_img@2x.png",@"ad_img@2x.png",nil];
    
    NSArray * array1 = @[@"http://mongol.ttcy.com/image_app_ad/iosAppAdv_1.jpg",@"http://mongol.ttcy.com/image_app_ad/iosAppAdv_2.jpg"];
    ...
    for (NSString *imageUrl in array) {
        ...
        [imageView setImageWithURL:[NSURL URLWithString:array1[i]] placeholderImage:[UIImage imageNamed:array[i]]];
