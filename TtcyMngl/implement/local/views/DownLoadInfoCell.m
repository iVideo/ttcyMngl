...
- (void)createPauseButton
{
    ...
    _pauseButton.backgroundColor = NVC_COLOR;
...
- (void)createCancelButton
{
    ...
    _cancelButton.backgroundColor = NVC_COLOR;
    ...
    [self.contentView addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:|-5-[_pauseButton(25)]-5-[_cancelButton]-5-|" options:0 metrics:nil views:NSDictionaryOfVariableBindings(_pauseButton,_cancelButton)]];
}
