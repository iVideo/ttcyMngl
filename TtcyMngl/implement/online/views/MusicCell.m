...
+(id)newCell{
    ...
    UILabel *uiLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, CellH,1 )];
...
-(void)setMusicWithModel:(SongObject *)model{
    ...
    if (model.avatarImageUrl!=nil) {
        ...
        image.tag=1001;
        [image setImageWithURL:[NSURL URLWithString:model.avatarImageUrl] placeholderImage:[UIImage imageNamed:@"face.jpg"]];
