...
- (void)viewDidLoad
{
    [super viewDidLoad];
     ...
     UIScrollView *m_scrollView=[ImScrollView  ImScrollViewWithFrame:CGRectMake(navigationWhile+2, 0, kMainScreenWidth-navigationWhile-4, 86) jsonUrl:nil];
...
-(void)TypebtnClick:(UIButton *)selButton{
    ...
    _nonceType=selButton.tag;
      self.Url=[NSString stringWithFormat:@"/iosSeve.ashx?type=10&&pagesize=%d&&pageCount=%d&&ctype=%d",self.pageSize,1,_nonceType];
    [self loadMore];
}
